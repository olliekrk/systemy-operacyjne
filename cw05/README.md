...
1. otwiera potok nazwany
2. wypisuje swój PID na wyjście standardowe
3. N razy zapisuje do potoku nazwanego linijkę składającą się ze swojego PIDu oraz obecnej daty
